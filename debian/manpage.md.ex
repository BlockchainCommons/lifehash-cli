% lifehash-cli(SECTION) | User Commands
%
% "February 17 2023"
...
lifehash-cli - program to do something

# SYNOPSIS

**lifehash-cli** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**lifehash-cli** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **lifehash-cli** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**lifehash-cli** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    lifehash-cli. See **foo.conf**(5) for further details.
...
**lifehash-cli** provides some return codes, that can be used in scripts:
